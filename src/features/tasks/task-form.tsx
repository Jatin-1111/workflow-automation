        ...
        {stage.requiresApproval ? (
          <>
            ...
            <button
              ...
              formAction={reject}
              disabled={busy}
              className="rounded-md border border-border-strong bg-surface px-4 py-2 text-sm font-medium text-status-overdue transition hover:bg-accent-soft disabled:opacity-60"
            >
